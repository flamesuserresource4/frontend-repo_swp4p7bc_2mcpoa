  ...
  const steps = [
    {
      ...
      text: 'Mild, Medium, or Strong — crafted for every palate.',
    },
    {
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
          {steps.map((s, i) => (
            <div
              key={i}
              className="group relative rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-md transition hover:border-amber-400/30 hover:bg-white/10"
            >
